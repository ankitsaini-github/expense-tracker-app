      ...
      {updateform && 
        <Row md={2} className='w-100'>
          <Col md={4} className='d-flex flex-column align-items-center my-5'>
            <Image src={userdata.photourl} roundedCircle width='200px' className='border'/>
            <strong>{userdata.displayname}</strong>
            <strong>{userdata.email}</strong>
          </Col>
          <Col md={8}>
            <Form className='my-5 border-bottom border-2 p-3' onSubmit={submitHandler}>
              ...
              <Row className='my-3'>
                <Col>
                  <Form.Group as={Row} className="mb-3" controlId="userfullname">
                    ...
                    <Col sm="7">
                      <Form.Control type="text" placeholder="Full name" ref={newname} defaultValue={userdata.displayname}/>
                    </Col>
                  </Form.Group>
                </Col>
                <Col>
                  <Form.Group as={Row} className="mb-3" controlId="userprofileurl">
                    ...
                    <Col sm="7">
                      <Form.Control type="text" placeholder="" ref={newprofileurl} defaultValue={userdata.photourl}/>
                    </Col>
                  </Form.Group>
                </Col>
              </Row>
              <div className='w-100'>
                <Button variant='danger mb-1' type='submit'>Update</Button>
              </div>
            </Form>
          </Col>
        </Row>}
